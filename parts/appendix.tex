...
\input{parts/appendix-curricula}
\appendix
\input{parts/appendix-01-meeting-log}
\input{parts/appendix-02-research-log}
\input{parts/appendix-03-vote-rules}
\input{parts/appendix-lessons-learned}
...
\end{boxcomment}
\input{parts/appendix-evaluating-decision-methods}
